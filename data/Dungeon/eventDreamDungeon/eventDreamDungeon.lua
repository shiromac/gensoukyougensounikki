...
function introSelfIntroEvent()
    ...
    eventNameKeyPrefix = _T("greenAndPurpleOpenDream_");
	clearMassage()
	...
	storyEventMessageLoopRange(eventNameKeyPrefix, 3, 4, str_map, nil)
	...
	storyEventMessageLoopRange(eventNameKeyPrefix, 5, 8, str_map, nil)
	...
	storyEventMessageLoopRange(eventNameKeyPrefix, 9, 10, str_map, nil)

	cameraMove(PlayerCharacter().placeX,PlayerCharacter().placeY-1,1.5,1,1)
...
function introItemUseEvent()
	...
	storyEventMessageLoop(_T("greenAndPurpleOpenDream_"), str_map, nil)
