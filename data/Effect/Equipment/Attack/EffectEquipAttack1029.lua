...
-- sound
sound = AnimeChip_Sound("swing1029.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
aniBelt11 = AnimeChip_Belt("effect\\equip\\sword_swing2.png",PositionPerGrid(-0.5*random(), 0, 0.3*random()),PositionPerGrid(-0.5*random(), 0, 0.3*random()),life_swing)
...
aniBelt21 = AnimeChip_Belt("effect\\equip\\sword_swing2.png",PositionPerGrid(0.5*random(), 0, 0.3*random()),PositionPerGrid(0.5*random(), 0, 0.3*random()),life_swing)
aniBelt21:setDelay(9)
