...
-- sound
sound = AnimeChip_Sound("swing1026.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
-- =============================================================
-- 衝撃波
syougeki11 = AnimeChip_Perticle("effect\\basic\\ring_radio.png",D3DXVECTOR2(100,100), syougeki_life)
syougeki11.color: addCascade(Color(230,255,120,120), syougeki_life)
...
-- =============================================================
-- モミジ
momizi11 = AnimeChip_Perticle("effect\\equip\\particle_momizi.png",D3DXVECTOR2(60,60), syougeki_life)
momizi11.color: addCascade(Color(100,255,50,50), syougeki_life)
momizi11.drawMode: setDefault(DrawMode_normal)
--momizi11.rotationBefore: addCascade(360, 0, syougeki_life)
momizi11.scaleX:	addCascade(0.5, 1, syougeki_life)
momizi11.scaleY:	addCascade(0.5, 1, syougeki_life)
--momizi11:setWorldRotation(direction)
momizi11: setDelay(6)
momizi11.position: addCascade( PositionPerGrid(0, 0, 0.5), syougeki_life)
