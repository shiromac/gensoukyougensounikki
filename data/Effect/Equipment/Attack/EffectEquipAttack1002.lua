...
-- sound
sound = AnimeChip_Sound("swing1002.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
life_swing = 16
belt_point_num = 20
color_swing = Color(180,250,60,230)
...
aniBelt11.position: addCascade(PositionPerGrid(0, 0.0, 0.9), life_swing)
...
for k = 0, belt_point_num do
	...
	-- baseVector
	pos = PositionPerGrid(0.7, 0.1, 0.1)
	angle =  ( (k/belt_point_num)*530 + 180) * -MATH_PI/180
		
	-- rotation
	rotAxis = PositionPerGrid(-0.6, 0.1, 1.5)
...
aniBelt13.drawMode: setDefault(DrawMode_addition)
aniBelt13: setDelay(7)
