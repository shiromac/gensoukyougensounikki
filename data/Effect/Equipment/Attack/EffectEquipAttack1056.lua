...
-- sound
sound = AnimeChip_Sound("swing1056.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
life_swing = 10
belt_point_num = 20
color_swing = Color(120,255,255,100)
...
for k = 0, belt_point_num do
	...
	angle =  ( (k/belt_point_num)*230 + 290 ) * -MATH_PI/180	-- 回転角度
