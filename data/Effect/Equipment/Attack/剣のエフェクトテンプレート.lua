...
-- sound
sound = AnimeChip_Sound("swing27.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
aniBelt11 = AnimeChip_Belt("effect\\equip\\sword_swing.png",PositionPerGrid(0, -0.35, 0.5),PositionPerGrid(0, 0, 0),life_swing)
...
for k = 0, belt_point_num do
	...
	pos = PositionPerGrid(1.0, 0, 0)	-- ベースの位置ベクトル(先端位置)
	rotAxis = PositionPerGrid(0, 0, 1.0)	-- 回転軸
	
	angle =  ( (k/belt_point_num)*320 + 290 ) * -MATH_PI/180	-- 回転角度
