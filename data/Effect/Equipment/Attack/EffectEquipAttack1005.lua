...
-- sound
sound = AnimeChip_Sound("swing1005.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
aniBelt11.position: addCascade(PositionPerGrid(0, 1.3, 0.6), life_swing)
...
for k = 0, belt_point_num do
	...
	pos = PositionPerGrid(-1.0, 0, -0.1)
	rotAxis = PositionPerGrid(-0.3, 0, 1)
	angle =  ( (k/belt_point_num)*120 + 20) * MATH_PI/180
	D3DXVec3Rotate( pos, rotAxis, angle, pos )
	
	oku	= pos + ( pos * sinSita*0.8 )
	temae	= pos + ( pos * sinSita* -0.1 )
