...
-- sound
sound = AnimeChip_Sound("swing1006.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
life_swing = 12
belt_point_num = 30
color_swing = Color(150,170,170,220)
...
for k = 0, belt_point_num do
	...
	angle =  ( (k/belt_point_num)*330 + 260 ) * -MATH_PI/180
