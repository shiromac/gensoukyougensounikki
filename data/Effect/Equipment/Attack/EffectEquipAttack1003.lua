...
-- sound
sound = AnimeChip_Sound("swing1003.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
life_swing = 16
belt_point_num = 40
color_swing = Color(150,150,150,250)
...
aniBelt11.position: addCascade(PositionPerGrid(0, -0.5, 0.7), life_swing)
