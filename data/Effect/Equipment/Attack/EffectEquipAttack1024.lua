...
-- sound
sound = AnimeChip_Sound("swing1024.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
life_swing = 10
belt_point_num = 20
color_swing = Color(80,200,200,250)
...
for k = 0, belt_point_num do
	...
	-- baseVector
	pos = PositionPerGrid(1.0, 0.05, 0.05)
	angle =  ( (k/belt_point_num)*200 - 30) * -MATH_PI/180
		
	-- rotation
	rotAxis = PositionPerGrid(-0.1, 0.1, 1.0)
