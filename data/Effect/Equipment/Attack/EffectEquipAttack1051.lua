...
-- sound
sound = AnimeChip_Sound("swing1051.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
life_swing = 12
belt_point_num = 20
color_swing = Color(80,255,230,250)
...
for k = 0, belt_point_num do
	...
	angle =  ( (k/belt_point_num)*180 - 30 ) * MATH_PI/180	-- 回転角度
...
-- =============================================================
-- 禁止マーク
momizi11 = AnimeChip_Perticle("effect\\equip\\kinsi.png",D3DXVECTOR2(60,60), syougeki_life)
momizi11.color: addCascade(Color(140,255,255,255), syougeki_life)
momizi11.drawMode: setDefault(DrawMode_normal)
--momizi11.rotationBefore: addCascade(360, 0, syougeki_life)
momizi11.scaleX:	addCascade(0.7, 1, syougeki_life)
momizi11.scaleY:	addCascade(0.7, 1, syougeki_life)
