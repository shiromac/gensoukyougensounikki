...
-- sound
sound = AnimeChip_Sound("swing1021.wav",PositionPerGrid(toPlaceX,toPlaceY,0),1.0)
...
life_swing = 12
belt_point_num = 30
--color_swing = Color(100,170,170,230)
...
aniBelt11.color: addCascade(Color(250,250,100,100), Color(150,250,100,100), Color(100,100,100,230), Color(20,100,100,230), life_swing)
...
for k = 0, belt_point_num do
	pos = PositionPerGrid(1.2, 0, 0)
	rotAxis = PositionPerGrid(0, -0.0, 1)
	angle =  ( (k/belt_point_num)*250 + 300 ) * -MATH_PI/180
