...
function bossMoveTargetLandform()
    ...
    local partner = searchOneCharacterOnFloor(5005);
...
function skillEffect(valiable)
    ...
    lazerSummon(landformAroundOfCharacter(boss, 7, 1), (boss.aspect+2)%8,2, 30, CHARACTER_FORSE_ENEMY, Color(255,255,255,137), 0, 0, false, true);
