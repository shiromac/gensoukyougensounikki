    ...
    for x = -gSwordLength , gSwordLength do
        for y = -gSwordLength , gSwordLength do
            ...
            if not(skipFlag) then
                attackHappen(boss, targetLand, meisouzan_damage, 0, attackAttributes, false)
            end
        end
    end
end
...
function startSpell()
    ...
    CharacterThrow(boss,boss, LandformRandom_RoomRandom_OutOfSight_Safe(LandformCharacterPosition(PlayerCharacter())), 0, YES, 2.0);
