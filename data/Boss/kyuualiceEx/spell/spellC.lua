            ...
            then
                ...
                then
                    ...
                    then
                        ...
                        lazerSummon(LandformNearby(bltland, ASPECT_DOWN,1), ASPECT_DOWN,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
                        lazerSummon(LandformNearby(bltland, ASPECT_UP,1), ASPECT_UP,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
                        lazerSummon(LandformNearby(bltland, ASPECT_LEFT,1), ASPECT_LEFT,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
                        lazerSummon(LandformNearby(bltland, ASPECT_RIGHT,1), ASPECT_RIGHT,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
                        
                        lazerSummon(LandformNearby(bltland, ASPECT_DOWNLEFT,1), ASPECT_DOWNLEFT,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
                        lazerSummon(LandformNearby(bltland, ASPECT_UPRIGHT,1), ASPECT_UPRIGHT,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
                        lazerSummon(LandformNearby(bltland, ASPECT_UPLEFT,1), ASPECT_UPLEFT,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
                        lazerSummon(LandformNearby(bltland, ASPECT_DOWNRIGHT,1), ASPECT_DOWNRIGHT,distance, ValiableConstant3, CHARACTER_FORSE_ENEMY, baku_color, 0, 0, false, true);
