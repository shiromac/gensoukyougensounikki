...
function rollingLazer(turn, lazer_color)
    ...
    then
        ...
        lazerSummon(pland, turn%8,MAPHEIGHT*2, ValiableConstant3, CHARACTER_FORSE_ENEMY, lazer_color, 2, 7, false, true);
   else
        pland = LandformNearby(LandformPlace(boss.placeX, boss.placeY), (16-turn)%8,1);
        lazerSummon(pland, (16-turn)%8,MAPHEIGHT*2, ValiableConstant3, CHARACTER_FORSE_ENEMY, lazer_color, 2, 7, false, true);
    end
end
