...
function enemy1(enemyPlace, enemyWay)
    ...
    then
        newEnemy = MakeCharacter(2035, 5, CHARACTER_FORSE_ENEMY, enemyPlace[1]);--orin
        table.insert(surviveEnemy, newEnemy);
        num=2;
    end
    
    newEnemy = MakeCharacter(2012, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--yomu
    table.insert(surviveEnemy, newEnemy);
    
    newEnemy = MakeCharacter(2013, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--chiruno
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy2(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2011, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--yuyuko
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2067, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--kanako
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2047, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+2]);--kaguya
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy3(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2038, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--koisi
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2075, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--kene
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy4(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2041, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--alice
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2036, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--yamame
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy5(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2072, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--3gatsu sunny milk
    table.insert(surviveEnemy, newEnemy);
    ...
    newEnemy = MakeCharacter(2054, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--runasa
    table.insert(surviveEnemy, newEnemy);
    ...
    newEnemy = MakeCharacter(2029, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+2]);--tenko
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2005, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+3]);--huran
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy6(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2051, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--misstia
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2034, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--kisume
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2043, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+2]);--chen
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2007, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+3]);--rumia
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy7(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2055, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--medi
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2030, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--parusi
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2056, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+2]);--yuka
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy8(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2032, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--momiji
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2022, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--sanae
    table.insert(surviveEnemy, newEnemy);
end
...
function enemy9(enemyPlace, enemyWay)
    ...
    newEnemy = MakeCharacter(2018, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num]);--aya
    table.insert(surviveEnemy, newEnemy);
    newEnemy = MakeCharacter(2027, 5, CHARACTER_FORSE_ENEMY, enemyPlace[num+1]);--suica
    table.insert(surviveEnemy, newEnemy);
end
