...
function lazerLock(count)
    ...
    lazerSummon(pland, startWay,MAPHEIGHT*2, ValiableConstant3, CHARACTER_FORSE_ENEMY, Color(137,137,137,137), 2, 3, true, true);
