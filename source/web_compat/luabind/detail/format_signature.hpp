...
//
// Emscripten compatibility overlay for luabind 0.9.1.
// Modern clang/libc++ rejects the original forward declarations of
// luabind::object, luabind::argument, and luabind::table after object.hpp
// imports the real adl types with using declarations. Include object.hpp and
// specialize against the imported names instead.
