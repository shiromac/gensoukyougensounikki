...
function Add-WebPageControls([string]$content) {
    ...
    if ($content.Contains("</style>")) {
        $content = $content.Replace("</style>", $pageControlStyle + $portraitControlStyle + "</style>")
    }
