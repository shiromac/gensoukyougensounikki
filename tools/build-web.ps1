...
function Add-WebPageControls([string]$content) {
    ...
    $visualViewportStyle = ':root{--ggn-safe-area-bottom:env(safe-area-inset-bottom,0px);--ggn-safe-area-left:env(safe-area-inset-left,0px);--ggn-safe-area-right:env(safe-area-inset-right,0px)}html.ggn-controls-hidden body.ggn-mobile-ready div.emscripten_border{height:var(--ggn-visual-viewport-height,100dvh)}@media (pointer:coarse) and (orientation:portrait),(max-width:900px) and (orientation:portrait){html body.ggn-mobile-ready{--ggn-controls-height:calc(var(--ggn-portrait-panel-height,var(--ggn-panel-height)) + max(12px,env(safe-area-inset-bottom)))}html body.ggn-mobile-ready #ggn-touch-controls{inset:0;height:auto}html body.ggn-mobile-ready #ggn-touch-controls .ggn-pad{bottom:calc(var(--ggn-visual-viewport-bottom,0px) + max(12px,env(safe-area-inset-bottom)));transform:scale(var(--ggn-portrait-pad-scale,1))}html body.ggn-mobile-ready #ggn-touch-controls .ggn-left{left:calc(var(--ggn-visual-viewport-left,0px) + max(8px,env(safe-area-inset-left)));transform-origin:bottom left}html body.ggn-mobile-ready #ggn-touch-controls .ggn-right{right:calc(var(--ggn-visual-viewport-right,0px) + max(8px,env(safe-area-inset-right)));transform-origin:bottom right}html body.ggn-mobile-ready div.emscripten_border{height:calc(var(--ggn-visual-viewport-height,100dvh) - var(--ggn-controls-height) - 12px)}html body.ggn-mobile-ready canvas.emscripten{width:min(var(--ggn-visual-viewport-width,100%),calc((var(--ggn-visual-viewport-height,100dvh) - var(--ggn-controls-height) - 12px) * 1.333333))}}'
    ...
    if ($content.Contains("</style>")) {
        $content = $content.Replace("</style>", $pageControlStyle + $portraitCanvasStyle + $visualViewportStyle + $hiddenCanvasStyle + $visualViewportPositionStyle + "</style>")
    }
