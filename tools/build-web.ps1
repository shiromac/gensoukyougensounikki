...
function Add-WebPageControls([string]$content) {
    ...
    $portraitControlStyle = '@media (pointer:coarse) and (orientation:portrait),(max-width:900px) and (orientation:portrait){html body.ggn-mobile-ready{--ggn-portrait-utility-row:clamp(56px,8vh,64px);--ggn-portrait-utility-row:clamp(56px,8dvh,64px);--ggn-portrait-main-row:clamp(66px,11.25vh,76px);--ggn-portrait-main-row:clamp(66px,11.25dvh,76px);--ggn-portrait-action-row:calc(var(--ggn-portrait-main-row) + 8px);--ggn-controls-height:calc(var(--ggn-portrait-utility-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-action-row) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap) + max(12px,env(safe-area-inset-bottom)))}html body.ggn-mobile-ready #ggn-touch-controls .ggn-pad{left:50%;right:auto;bottom:max(12px,env(safe-area-inset-bottom));top:auto;width:min(calc(100vw - 16px),520px);height:calc(var(--ggn-portrait-utility-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-action-row) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap));grid-template-columns:repeat(4,minmax(0,1fr));grid-template-rows:var(--ggn-portrait-utility-row) repeat(3,var(--ggn-portrait-main-row)) var(--ggn-portrait-action-row);gap:var(--ggn-gap);transform:translateX(-50%)}html body.ggn-mobile-ready #ggn-touch-controls button{font-size:clamp(15px,4vw,18px)}html body.ggn-mobile-ready #ggn-touch-controls button.ggn-wide{font-size:clamp(15px,4.2vw,19px)}html body.ggn-mobile-ready #ggn-touch-controls button.ggn-big{font-size:clamp(20px,6vw,26px)}html body.ggn-mobile-ready #ggn-btn-map{grid-column:1/span 2;grid-row:1}html body.ggn-mobile-ready #ggn-btn-menu{grid-column:3/span 2;grid-row:1}html body.ggn-mobile-ready #ggn-btn-up-left{grid-column:1;grid-row:2}html body.ggn-mobile-ready #ggn-btn-up{grid-column:2;grid-row:2}html body.ggn-mobile-ready #ggn-btn-up-right{grid-column:3;grid-row:2}html body.ggn-mobile-ready #ggn-btn-turn{grid-column:4;grid-row:2}html body.ggn-mobile-ready #ggn-btn-left{grid-column:1;grid-row:3}html body.ggn-mobile-ready #ggn-btn-step{grid-column:2;grid-row:3}html body.ggn-mobile-ready #ggn-btn-right{grid-column:3;grid-row:3}html body.ggn-mobile-ready #ggn-btn-diag{grid-column:4;grid-row:3}html body.ggn-mobile-ready #ggn-btn-down-left{grid-column:1;grid-row:4}html body.ggn-mobile-ready #ggn-btn-down{grid-column:2;grid-row:4}html body.ggn-mobile-ready #ggn-btn-down-right{grid-column:3;grid-row:4}html body.ggn-mobile-ready #ggn-btn-shot{grid-column:4;grid-row:4}html body.ggn-mobile-ready #ggn-btn-attack{grid-column:1;grid-row:5}html body.ggn-mobile-ready #ggn-btn-dash{grid-column:2;grid-row:5}html body.ggn-mobile-ready #ggn-btn-smartdash{grid-column:3/span 2;grid-row:5}}'
