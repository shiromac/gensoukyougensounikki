...
function Add-WebPageControls([string]$content) {
    ...
    $pageControlStyle = '#ggn-page-links{box-sizing:border-box;width:min(100vw,calc(100vh * 1.333333));margin:6px auto 4px;padding:0 8px;text-align:right;font:700 13px/1.4 Arial,sans-serif;position:relative;z-index:30;display:flex;gap:4px;justify-content:flex-end;align-items:center}#ggn-page-links a,#ggn-page-links button{box-sizing:border-box;color:#dfe9ff;text-decoration:none;border:1px solid rgba(255,255,255,.5);border-radius:6px;padding:4px 8px;background:rgba(0,0,0,.55);font:inherit;line-height:inherit;cursor:pointer;touch-action:manipulation;-webkit-tap-highlight-color:transparent}#ggn-controls-toggle{display:none}#ggn-page-links a:focus-visible,#ggn-page-links button:focus-visible{outline:2px solid #fff;outline-offset:2px}html:fullscreen,html:-webkit-full-screen{background:#050505}html.ggn-controls-hidden #ggn-touch-controls{display:none!important}html.ggn-controls-hidden #ggn-fullscreen-button,html.ggn-controls-hidden #ggn-page-links a{display:none!important}html.ggn-controls-hidden body.ggn-mobile-ready div.emscripten_border{height:100vh;height:100dvh;align-items:center;padding-left:0;padding-right:0}@media (pointer:coarse),(max-width:900px){#ggn-page-links{font-size:14px;margin-top:4px}#ggn-page-links a,#ggn-page-links button{display:inline-block;padding:6px 10px}#ggn-controls-toggle{display:inline-block}}@media (pointer:coarse) and (orientation:landscape),(max-width:900px) and (orientation:landscape){body.ggn-mobile-ready #ggn-page-links a,body.ggn-mobile-ready #ggn-page-links button{padding:1px 6px}}'
    $portraitControlStyle = '@media (pointer:coarse) and (orientation:portrait),(max-width:900px) and (orientation:portrait){html body.ggn-mobile-ready{--ggn-portrait-utility-row:clamp(56px,8vh,64px);--ggn-portrait-utility-row:clamp(56px,8dvh,64px);--ggn-portrait-main-row:clamp(66px,11.25vh,76px);--ggn-portrait-main-row:clamp(66px,11.25dvh,76px);--ggn-portrait-action-extra:8px;--ggn-portrait-action-row:calc(var(--ggn-portrait-main-row) + var(--ggn-portrait-action-extra));--ggn-controls-height:calc(var(--ggn-portrait-utility-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-action-extra) + var(--ggn-portrait-action-extra) + var(--ggn-portrait-action-extra) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap) + max(12px,env(safe-area-inset-bottom)))}html body.ggn-mobile-ready #ggn-touch-controls .ggn-pad{left:50%;right:auto;bottom:max(12px,env(safe-area-inset-bottom));top:auto;width:min(calc(100vw - 16px),520px);height:calc(var(--ggn-portrait-utility-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-main-row) + var(--ggn-portrait-action-extra) + var(--ggn-portrait-action-extra) + var(--ggn-portrait-action-extra) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap) + var(--ggn-gap));grid-template-columns:repeat(4,minmax(0,1fr));grid-template-rows:var(--ggn-portrait-utility-row) repeat(3,var(--ggn-portrait-action-row)) var(--ggn-portrait-main-row);column-gap:var(--ggn-gap);row-gap:var(--ggn-gap);transform:translateX(-50%)}html body.ggn-mobile-ready #ggn-touch-controls button{font-size:clamp(15px,4vw,18px)}html body.ggn-mobile-ready #ggn-touch-controls button.ggn-wide{font-size:clamp(15px,4.2vw,19px)}html body.ggn-mobile-ready #ggn-touch-controls button.ggn-big{font-size:clamp(15px,min(6vw,calc((var(--ggn-portrait-action-row) - 4px)/2.1)),26px)}html body.ggn-mobile-ready #ggn-btn-map{grid-column:1/span 2;grid-row:1}html body.ggn-mobile-ready #ggn-btn-menu{grid-column:3/span 2;grid-row:1}html body.ggn-mobile-ready #ggn-btn-up-left{grid-column:1;grid-row:2}html body.ggn-mobile-ready #ggn-btn-up{grid-column:2;grid-row:2}html body.ggn-mobile-ready #ggn-btn-up-right{grid-column:3;grid-row:2}html body.ggn-mobile-ready #ggn-btn-attack{grid-column:4;grid-row:2}html body.ggn-mobile-ready #ggn-btn-left{grid-column:1;grid-row:3}html body.ggn-mobile-ready #ggn-btn-step{grid-column:2;grid-row:3}html body.ggn-mobile-ready #ggn-btn-right{grid-column:3;grid-row:3}html body.ggn-mobile-ready #ggn-btn-dash{grid-column:4;grid-row:3}html body.ggn-mobile-ready #ggn-btn-down-left{grid-column:1;grid-row:4}html body.ggn-mobile-ready #ggn-btn-down{grid-column:2;grid-row:4}html body.ggn-mobile-ready #ggn-btn-down-right{grid-column:3;grid-row:4}html body.ggn-mobile-ready #ggn-btn-smartdash{grid-column:4;grid-row:4}html body.ggn-mobile-ready #ggn-btn-turn{grid-column:1;grid-row:5}html body.ggn-mobile-ready #ggn-btn-diag{grid-column:2;grid-row:5}html body.ggn-mobile-ready #ggn-btn-shot{grid-column:4;grid-row:5}}'
    $portraitCanvasStyle = '@media (pointer:coarse) and (orientation:portrait),(max-width:900px) and (orientation:portrait){html body.ggn-mobile-ready canvas.emscripten{box-sizing:border-box;width:min(100%,calc((100vh - var(--ggn-controls-height) - 12px) * 1.333333));width:min(100%,calc((100dvh - var(--ggn-controls-height) - 12px) * 1.333333));height:auto;max-height:100%;aspect-ratio:4/3}}'
    $visualViewportStyle = ':root{--ggn-safe-area-bottom:env(safe-area-inset-bottom,0px)}html.ggn-controls-hidden body.ggn-mobile-ready div.emscripten_border{height:var(--ggn-visual-viewport-height,100dvh)}@media (pointer:coarse) and (orientation:portrait),(max-width:900px) and (orientation:portrait){html body.ggn-mobile-ready{--ggn-portrait-utility-row:var(--ggn-synced-portrait-utility-row,clamp(56px,8dvh,64px));--ggn-portrait-main-row:var(--ggn-synced-portrait-main-row,clamp(66px,11.25dvh,76px));--ggn-portrait-action-extra:var(--ggn-synced-portrait-action-extra,8px)}html body.ggn-mobile-ready #ggn-touch-controls{inset:0;height:auto}html body.ggn-mobile-ready #ggn-touch-controls .ggn-pad{left:var(--ggn-visual-viewport-center-x,50%);bottom:calc(var(--ggn-visual-viewport-bottom,0px) + max(12px,env(safe-area-inset-bottom)));width:min(calc(var(--ggn-visual-viewport-width,100vw) - 16px),520px)}html body.ggn-mobile-ready div.emscripten_border{height:calc(var(--ggn-visual-viewport-height,100dvh) - var(--ggn-controls-height) - 12px)}html body.ggn-mobile-ready canvas.emscripten{width:min(var(--ggn-visual-viewport-width,100%),calc((var(--ggn-visual-viewport-height,100dvh) - var(--ggn-controls-height) - 12px) * 1.333333))}}'
    $hiddenCanvasStyle = 'html.ggn-controls-hidden body.ggn-mobile-ready canvas.emscripten{width:min(var(--ggn-visual-viewport-width,100vw),calc(var(--ggn-visual-viewport-height,100dvh) * 1.333333));height:auto;max-height:var(--ggn-visual-viewport-height,100dvh);aspect-ratio:4/3}'
    $visualViewportPositionStyle = ':root{--ggn-safe-area-top:env(safe-area-inset-top,0px)}html.ggn-controls-hidden body.ggn-mobile-ready div.emscripten_border{position:fixed;left:var(--ggn-visual-viewport-left,0px);top:var(--ggn-visual-viewport-top,0px);width:var(--ggn-visual-viewport-width,100vw)}@media (pointer:coarse) and (orientation:portrait),(max-width:900px) and (orientation:portrait){html body.ggn-mobile-ready #ggn-page-links{top:calc(var(--ggn-visual-viewport-top,0px) + max(4px,env(safe-area-inset-top)));right:calc(var(--ggn-visual-viewport-right,0px) + max(8px,env(safe-area-inset-right)))}html body.ggn-mobile-ready div.emscripten_border{position:fixed;left:var(--ggn-visual-viewport-left,0px);top:calc(var(--ggn-visual-viewport-top,0px) + var(--ggn-portrait-page-strip,40px));width:var(--ggn-visual-viewport-width,100vw);height:calc(var(--ggn-visual-viewport-height,100dvh) - var(--ggn-controls-height) - var(--ggn-portrait-page-strip,40px) - 12px)}html body.ggn-mobile-ready canvas.emscripten{width:min(var(--ggn-visual-viewport-width,100%),calc((var(--ggn-visual-viewport-height,100dvh) - var(--ggn-controls-height) - var(--ggn-portrait-page-strip,40px) - 12px) * 1.333333))}}'
    $audioLifecycleScript = '<script id="ggn-audio-lifecycle">(function(){if(window.ggnAudioLifecycle)return;var state={hidden:false,resumeOnShow:false,transition:Promise.resolve()};window.ggnAudioLifecycle=state;function audio(){return typeof Module!=="undefined"&&Module.ggnAudio?Module.ggnAudio:null}function queue(action){state.transition=state.transition.then(action,action).catch(function(error){console.warn("[ggn audio lifecycle]",error)});return state.transition}function mute(audioState,value){if(audioState&&audioState.masterGain)audioState.masterGain.gain.value=value}function suspend(){state.hidden=true;var audioState=audio();if(!audioState)return;mute(audioState,0);var ctx=audioState.context;if(!ctx||ctx.state==="closed")return;if(ctx.state==="running"||audioState.bgmSources&&audioState.bgmSources.length)state.resumeOnShow=true;queue(function(){if(!state.hidden||ctx.state!=="running")return;return ctx.suspend()})}function resume(){state.hidden=false;var audioState=audio();if(!audioState)return;mute(audioState,1);var ctx=audioState.context;if(!ctx||ctx.state==="closed"||!state.resumeOnShow)return;queue(function(){if(state.hidden||!state.resumeOnShow)return;if(ctx.state==="running"){state.resumeOnShow=false;return}if(ctx.state!=="suspended"&&ctx.state!=="interrupted")return;return Promise.resolve(ctx.resume()).then(function(){if(!state.hidden&&ctx.state==="running")state.resumeOnShow=false})})}state.suspend=suspend;state.resume=resume;document.addEventListener("visibilitychange",function(){if(document.hidden)suspend();else resume()},false);window.addEventListener("pagehide",suspend,false);window.addEventListener("pageshow",function(){if(!document.hidden)resume()},false);document.addEventListener("freeze",suspend,false);if(document.hidden)suspend()})();</script>'
    $visualViewportScript = '<script id="ggn-visual-viewport">(function(){if(window.ggnVisualViewport)return;var root=document.documentElement,frame=0;function clamp(value,min,max){return Math.max(min,Math.min(max,value))}function px(value){return Math.round(Math.max(0,value)*100)/100+"px"}function sync(){frame=0;var viewport=window.visualViewport,width=viewport&&viewport.width||window.innerWidth||root.clientWidth,height=viewport&&viewport.height||window.innerHeight||root.clientHeight,left=viewport&&viewport.offsetLeft||0,top=viewport&&viewport.offsetTop||0,layoutWidth=Math.max(root.clientWidth||0,window.innerWidth||0,left+width),layoutHeight=Math.max(root.clientHeight||0,window.innerHeight||0,top+height),safeTop=0,safeBottom=0;try{var computedRoot=getComputedStyle(root);safeTop=parseFloat(computedRoot.getPropertyValue("--ggn-safe-area-top"))||0;safeBottom=parseFloat(computedRoot.getPropertyValue("--ggn-safe-area-bottom"))||0}catch(ignore){}var pageStrip=Math.max(40,safeTop+36),utility=clamp(height*.08,56,64),main=clamp(height*.1125,66,76),minimumCanvas=clamp(height*.2,48,96),availableTracks=Math.max(0,height-pageStrip-minimumCanvas-16-12-Math.max(12,safeBottom)),rowBudget=Math.max(0,availableTracks-24),rowTotal=utility+4*main;if(rowTotal>rowBudget&&rowBudget>0){var scale=rowBudget/rowTotal;utility=Math.max(32,utility*scale);main=Math.max(32,main*scale);if(utility+4*main>rowBudget){utility=Math.max(32,Math.min(utility,rowBudget/5));main=Math.max(32,(rowBudget-utility)/4)}}var actionExtra=clamp((availableTracks-utility-4*main)/3,0,8);root.style.setProperty("--ggn-visual-viewport-width",px(width));root.style.setProperty("--ggn-visual-viewport-height",px(height));root.style.setProperty("--ggn-visual-viewport-left",px(left));root.style.setProperty("--ggn-visual-viewport-top",px(top));root.style.setProperty("--ggn-visual-viewport-right",px(layoutWidth-left-width));root.style.setProperty("--ggn-visual-viewport-bottom",px(layoutHeight-top-height));root.style.setProperty("--ggn-visual-viewport-center-x",px(left+width/2));root.style.setProperty("--ggn-portrait-page-strip",px(pageStrip));root.style.setProperty("--ggn-synced-portrait-utility-row",px(utility));root.style.setProperty("--ggn-synced-portrait-main-row",px(main));root.style.setProperty("--ggn-synced-portrait-action-extra",px(actionExtra))}function schedule(){if(frame)return;var requestFrame=window.requestAnimationFrame||function(callback){return setTimeout(callback,0)};frame=requestFrame(sync)}var viewport=window.visualViewport;if(viewport){viewport.addEventListener("resize",schedule,false);viewport.addEventListener("scroll",schedule,false)}window.addEventListener("resize",schedule,false);window.addEventListener("orientationchange",schedule,false);window.ggnVisualViewport={sync:sync,schedule:schedule};sync()})();</script>'
    $pageControls = '<div id="ggn-page-links"><button id="ggn-fullscreen-button" type="button" aria-label="&#20840;&#30011;&#38754;&#34920;&#31034;" aria-pressed="false">&#20840;&#30011;&#38754;</button><button id="ggn-controls-toggle" type="button" aria-label="&#25805;&#20316;&#12508;&#12479;&#12531;&#12434;&#38750;&#34920;&#31034;" aria-pressed="false">&#25805;&#20316;&#38750;&#34920;&#31034;</button><a href="../manual/" target="_blank" rel="noopener">&#12510;&#12491;&#12517;&#12450;&#12523;</a></div><script>(function(){var b=document.getElementById("ggn-fullscreen-button"),c=document.getElementById("ggn-controls-toggle"),root=document.documentElement;if(!b||!c)return;var controlsStorageKey="ggn-touch-controls-hidden";function active(){return!!(document.fullscreenElement||document.webkitFullscreenElement)}function sync(){var on=active();b.textContent=on?"戻す":"全画面";b.setAttribute("aria-pressed",on?"true":"false");b.setAttribute("aria-label",on?"全画面を終了":"全画面表示")}function fallback(){alert("このブラウザでは全画面表示を利用できません。iPhone/iPadでは共有メニューから「ホーム画面に追加」→「Webアプリとして開く」を有効にし、追加したアイコンから起動してください。")}function settle(result){if(result&&result.then)result.then(function(){sync();setTimeout(sync,1000)}).catch(function(){sync();fallback()});else setTimeout(sync,0)}function controlsHidden(){return root.classList.contains("ggn-controls-hidden")}function syncControls(){var hidden=controlsHidden();c.textContent=hidden?"操作表示":"操作非表示";c.setAttribute("aria-pressed",hidden?"true":"false");c.setAttribute("aria-label",hidden?"操作ボタンを表示":"操作ボタンを非表示")}function setControlsHidden(hidden,persist){root.classList.toggle("ggn-controls-hidden",!!hidden);if(hidden){try{window.dispatchEvent(new Event("blur"))}catch(ignore){}}if(persist){try{localStorage.setItem(controlsStorageKey,hidden?"1":"0")}catch(ignore){}}syncControls()}b.addEventListener("click",function(e){e.preventDefault();e.stopPropagation();try{var fn;if(active()){fn=document.exitFullscreen||document.webkitExitFullscreen;if(!fn){fallback();return}var exitResult=fn.call(document);settle(exitResult)}else{fn=root.requestFullscreen||root.webkitRequestFullscreen;if(!fn){fallback();return}var requestResult=fn.call(root,{navigationUI:"hide"});settle(requestResult)}}catch(ignore){sync();fallback()}},false);c.addEventListener("click",function(e){e.preventDefault();e.stopPropagation();setControlsHidden(!controlsHidden(),true)},false);document.addEventListener("fullscreenchange",sync,false);document.addEventListener("webkitfullscreenchange",sync,false);try{if(localStorage.getItem(controlsStorageKey)==="1")setControlsHidden(true,false)}catch(ignore){}setInterval(sync,1000);sync();syncControls()})();</script>'
    $mobileAppMeta = '<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no,viewport-fit=cover"><meta name="theme-color" content="#050505"><meta name="mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">'

    if ($content.Contains("</style>")) {
        $content = $content.Replace("</style>", $pageControlStyle + $portraitControlStyle + $portraitCanvasStyle + $visualViewportStyle + $hiddenCanvasStyle + $visualViewportPositionStyle + "</style>")
    }
    if ($content.Contains("</head>")) {
        $content = $content.Replace("</head>", $mobileAppMeta + "</head>")
    }
    if ($content.Contains("<body>")) {
        $content = $content.Replace("<body>", "<body>" + $audioLifecycleScript + $visualViewportScript + $pageControls)
    }
